...
df = pd.read_json('transfers-2018_19-20191004.json', lines=True)
count = 0
arr = []
exist = False
...
result_file = open("club_list.csv", "w", encoding='utf-8')
for r in my_list:
    result_file.write(r + "\n")
result_file.close()

result_file = open("club_list.txt", "w", encoding='utf-8')
for r in my_list:
    result_file.write(r + "\n")
result_file.close()
